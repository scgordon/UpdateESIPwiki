./bedi-esip.py -v "Concepts_Glossary" wikiGlossary/Concepts_Glossary.txt
./bedi-esip.py -v "Concepts_Glossary_ISO" wikiGlossary/Concepts_Glossary_ISO.txt
./bedi-esip.py -v "Concepts_Glossary_DIF" wikiGlossary/Concepts_Glossary_DIF.txt
./bedi-esip.py -v "Concepts_Glossary_DIF-10" wikiGlossary/Concepts_Glossary_DIF-10.txt
